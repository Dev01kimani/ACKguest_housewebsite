              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div className="flex justify-between"><span>Bed Only:</span><span>KSh {room.bed_only.toLocaleString()}</span></div>
                    <div className="flex justify-between"><span>B&B:</span><span>KSh {room.bb.toLocaleString()}</span></div>
                    <div className="flex justify-between"><span>Half Board:</span><span>KSh {room.half_board.toLocaleString()}</span></div>
                    <div className="flex justify-between"><span>Full Board:</span><span>KSh {room.full_board.toLocaleString()}</span></div>
                  </div>
                </div>
